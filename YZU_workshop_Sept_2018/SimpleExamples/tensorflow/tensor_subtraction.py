...
# subtraction = tf.subtract(a, b, name="mysubtraction")
# subtraction = a - b
...
with tf.Session() as sess:
    ...
    print(subtraction.get_shape()) # ---> WHY
    print(subtraction.get_shape().as_list()) # ----> WHY
    print(subtraction)

    print("\nThe answer got from evaluating tensor A and B is:\n")
    # eval expressions with parameters for subtraction
    print(sess.run(subtraction, feed_dict={a: a_numpy, b: b_numpy}))
    # print(subtraction)
