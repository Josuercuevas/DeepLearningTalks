...
addition = tf.add(a, b)
# addition = tf.add(a, b, name='mysumm')
# addition = a + b
...
with tf.Session() as sess:
    ...
    print(addition.get_shape()) # ---> WHY
    print(addition.get_shape().as_list()) # ----> WHY
    print(addition)

    print("\nThe answer got from evaluating tensor A and B is:\n")
    # eval expressions with parameters for addition
    print(sess.run(addition, feed_dict={a: a_numpy, b: b_numpy}))
    # print(addition)
