...
# multiplication = tf.multiply(a, b, name="mymultiplciation")
# multiplication = a * b
...
with tf.Session() as sess:
    ...
    print(multiplication.get_shape()) # ---> WHY
    print(multiplication.get_shape().as_list()) # ----> WHY
    print(multiplication)

    print("\nThe answer got from evaluating tensor A and B is:\n")
    # eval expressions with parameters for multiplication
    print(sess.run(multiplication, feed_dict={a: a_numpy, b: b_numpy}))
    # print(multiplication)
